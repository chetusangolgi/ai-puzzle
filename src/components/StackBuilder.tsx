...
  return (
    <div className="min-h-screen flex touch-pan-y" style={{ backgroundImage: 'url(/s03.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
...
            <div className="flex items-center mb-6">
              <div className="w-4 h-8 bg-slate-800 mr-4"></div>
              <h3 className="text-3xl  font-medium text-slate-700">Select the right solution for your stack</h3>
            </div>
...
                    className={` border border-blue-200 rounded-lg p-4 cursor-grab hover:cursor-grabbing transition-all duration-300 hover:shadow-lg hover:scale-105 touch-manipulation select-none ${
                      draggedItem === option.id ? "opacity-60 scale-95 shadow-xl cursor-grabbing" : ""
                    } ${touchedItem === option.id ? "scale-110 shadow-2xl z-10" : ""}`}
                    style={{ width: '230px', height: '201px', backgroundColor: '#C5D4E3' }}
                  >
                    <div className="h-full flex flex-col justify-between">
                      <h4 className="text-3xl font-thin text-left">{option.text}</h4>
...
            <h2 className="text-slate-800 text-white  text-3xl mb-2 text-left">Drag and drop the correct components into each</h2>
            <h2 className="text-slate-800 text-white   text-3xl  text-left">category to assemble your optimal AI Stack</h2>
          </div>
...
                className={`transition-all duration-300 ease-in-out relative flex flex-row items-center justify-center p-6 min-h-[120px] transform touch-manipulation ${
